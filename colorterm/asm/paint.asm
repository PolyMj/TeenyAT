...
; ARRAYS AND WHATNOT
    ...
    ; Paint-mode settings:
        ...
        .var paint_textured_intensity   0
...
!main
    ...
    str [paint_textured_randomness], rB
...
!pcb_textured
    lod rA, [paint_textured_true_rand]
    set rB, rZ
    ...
    lod rA, [paint_textured_intensity_ptr]
    add rA, rB
...
!config_texture
    ...
    set rB, !charater_gradient
    add rB, rA
    str [paint_textured_intensity_ptr], rB
